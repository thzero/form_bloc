...
class ValueItemDropdownFieldBlocBuilder<Value, Item> extends StatelessWidget {
  const ValueItemDropdownFieldBlocBuilder({
    Key? key,
  ...
  final ValueItemSelectFieldBloc<Value, Item, dynamic> selectFieldBloc;

  /// {@macro flutter_form_bloc.FieldBlocBuilder.errorBuilder}
  final FieldBlocErrorBuilder? errorBuilder;

  /// {@macro flutter_form_bloc.FieldBlocBuilder.itemBuilder}
  final FieldItemBuilder<Item> itemBuilder;

  /// This function is invoked to render the selected item
  ///
  /// {@macro flutter_form_bloc.FieldBlocBuilder.itemBuilder}
  final ItemBuilder<Item>? selectedItemBuilder;
  ...
  DropdownFieldTheme themeStyleOf(BuildContext context) {
    ...
    final textOverflow = this.textOverflow ?? fieldTheme.textOverflow ?? TextOverflow.ellipsis;
    ...
    return DropdownFieldTheme(
      ...
      selectedTextStyle: selectedTextStyle ?? fieldTheme.selectedTextStyle ?? textStyle,
      selectedMaxLines: selectedMaxLines ?? fieldTheme.selectedMaxLines ?? maxLines,
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return SimpleFieldBlocBuilder(
      ...
      builder: (context, canShow) {
        return BlocBuilder<ValueItemSelectFieldBloc<Value, Item, dynamic>, ValueItemSelectFieldBlocState<Value, Item, dynamic>>(
              ...
              child: InputDecorator(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<Value>(
                        ...
                        (decoration.hintText != null
                            ? DefaultTextStyle(
                                style: Style.resolveTextStyle(
                                  isEnabled: isEnabled,
                                  style: decoration.hintStyle ?? fieldTheme.textStyle!,
                    ...
                    icon: this.decoration.suffixIcon ?? fieldTheme.moreIcon ?? const Icon(Icons.arrow_drop_down),
                  ),
                ),
              ),
            );
  ...
  Widget _buildDefaultTextStyle({
    ...
    return DefaultTextStyle(
      ...
      style: Style.resolveTextStyle(
        isEnabled: isEnabled,
        style: isSelected ? fieldTheme.selectedTextStyle! : fieldTheme.textStyle!,
        color: fieldTheme.textColor!,
      ),
      child: child,
    );
  ...
  List<DropdownMenuItem<Value>> _buildItems({
    ...
    required DropdownFieldTheme fieldTheme,
    required Map<Value, Item> items,
    required bool isSelected,
    required bool isEnabled,
  }) {
    final builder = (isSelected ? selectedItemBuilder : itemBuilder) ?? itemBuilder;

    // Map<String, String> map = MotorsSearchUtility.impulseClasses(context);
    ...
    return [
      ...
      ...items.keys.map<DropdownMenuItem<Value>>((key) {
  ...
  InputDecoration _buildDecoration(
    ...
    ValueItemSelectFieldBlocState<Value, Item, dynamic> state,
    bool isEnabled,
  ) {
