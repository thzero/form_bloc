...
abstract class FormBlocState<SuccessResponse, FailureResponse> extends Equatable {
  ...
  /// States by step
  late final Map<int, Map<String, dynamic>> _fieldBlocsStatesByStepMap = _fieldBlocs.map((key, value) {
  ...
  InputFieldBloc<Value, ExtraData>? inputFieldBlocOf<Value, ExtraData>(String name) => _singleFieldBlocOf(name);

  TextFieldBloc<ExtraData>? textFieldBlocOf<ExtraData>(String name) => _singleFieldBlocOf(name);

  BooleanFieldBloc<ExtraData>? booleanFieldBlocOf<ExtraData>(String name) => _singleFieldBlocOf(name);

  SelectFieldBloc<Value, ExtraData>? selectFieldBlocOf<Value, ExtraData>(String name) => _singleFieldBlocOf(name);

  ValueItemSelectFieldBloc<Value, Item, ExtraData>? valueItemSelectFieldBlocOf<Value, Item, ExtraData>(String name) => _singleFieldBlocOf(name);

  MultiSelectFieldBloc<Value, ExtraData>? multiSelectFieldBlocOf<Value, ExtraData>(String name) => _singleFieldBlocOf(name);

  GroupFieldBloc? groupFieldBlocOf(String name) => _fieldBlocOf<GroupFieldBloc>(name);

  ListFieldBloc<T, dynamic>? listFieldBlocOf<T extends FieldBloc>(String name) => _fieldBlocOf<ListFieldBloc<T, dynamic>>(name);
  ...
  FormBlocState<SuccessResponse, FailureResponse> toLoading({
    ...
    return FormBlocLoading(
      ...
      progress: progress ?? (state is FormBlocLoading<SuccessResponse, FailureResponse> ? state.progress : 0.0),
    );
  }
  ...
  FormBlocState<SuccessResponse, FailureResponse> toLoadFailed({FailureResponse? failureResponse}) {
    ...
    return FormBlocLoadFailed(
      isValidByStep: _isValidByStep,
      isEditing: isEditing,
      failureResponse: failureResponse ?? (state is FormBlocLoadFailed<SuccessResponse, FailureResponse> ? state.failureResponse : null),
      fieldBlocs: _fieldBlocs,
      currentStep: currentStep,
    );
  }
  ...
  FormBlocState<SuccessResponse, FailureResponse> toSubmitting({double? progress}) {
    ...
    return FormBlocSubmitting(
      isValidByStep: _isValidByStep,
      isEditing: isEditing,
      progress: progress ?? (state is FormBlocSubmitting<SuccessResponse, FailureResponse> ? state.progress : 0.0),
      isCanceling: state is FormBlocSubmitting<SuccessResponse, FailureResponse> ? state.isCanceling : false,
      fieldBlocs: _fieldBlocs,
      currentStep: currentStep,
    );
  }
  ...
  FormBlocState<SuccessResponse, FailureResponse> toFailure({
    ...
    return FormBlocFailure(
      isValidByStep: _isValidByStep,
      isEditing: isEditing,
      failureResponse: failureResponse ?? (state is FormBlocFailure<SuccessResponse, FailureResponse> ? state.failureResponse : null),
      fieldBlocs: _fieldBlocs,
      currentStep: currentStep,
    );
  }
  ...
  FormBlocState<SuccessResponse, FailureResponse> toSubmissionCancelled() => FormBlocSubmissionCancelled(
        isValidByStep: _isValidByStep,
        isEditing: isEditing,
        fieldBlocs: _fieldBlocs,
        currentStep: currentStep,
  ...
  FormBlocState<SuccessResponse, FailureResponse> toDeleteFailed({FailureResponse? failureResponse}) {
    final state = this;
    return FormBlocDeleteFailed(
      isValidByStep: _isValidByStep,
      isEditing: isEditing,
      failureResponse: failureResponse ?? (state is FormBlocDeleteFailed<SuccessResponse, FailureResponse> ? state.failureResponse : null),
      fieldBlocs: _fieldBlocs,
      currentStep: currentStep,
    );
  }
  ...
  FormBlocState<SuccessResponse, FailureResponse> toDeleteSuccessful({SuccessResponse? successResponse}) {
    final state = this;
    return FormBlocDeleteSuccessful(
      isValidByStep: _isValidByStep,
      isEditing: isEditing,
      successResponse: successResponse ?? (state is FormBlocDeleteSuccessful<SuccessResponse, FailureResponse> ? state.successResponse : null),
      fieldBlocs: _fieldBlocs,
      currentStep: currentStep,
    );
  }
  ...
  FormBlocState<SuccessResponse, FailureResponse> toUpdatingFields({double? progress}) {
    ...
    return FormBlocUpdatingFields(
      ...
      fieldBlocs: _fieldBlocs,
      currentStep: currentStep,
      progress: progress ?? (state is FormBlocUpdatingFields<SuccessResponse, FailureResponse> ? state.progress : 0.0),
    );
  }
...
class FormBlocLoading<SuccessResponse, FailureResponse> extends FormBlocState<SuccessResponse, FailureResponse> {
...
class FormBlocLoadFailed<SuccessResponse, FailureResponse> extends FormBlocState<SuccessResponse, FailureResponse> with EquatableMixin {
...
class FormBlocLoaded<SuccessResponse, FailureResponse> extends FormBlocState<SuccessResponse, FailureResponse> {
  FormBlocLoaded({
    Map<int, bool> isValidByStep = const {},
    bool isEditing = false,
    Map<int, Map<String, FieldBloc>> fieldBlocs = const {},
...
class FormBlocSubmitting<SuccessResponse, FailureResponse> extends FormBlocState<SuccessResponse, FailureResponse> with EquatableMixin {
...
class FormBlocSuccess<SuccessResponse, FailureResponse> extends FormBlocState<SuccessResponse, FailureResponse> with EquatableMixin {
...
class FormBlocFailure<SuccessResponse, FailureResponse> extends FormBlocState<SuccessResponse, FailureResponse> with EquatableMixin {
  final FailureResponse? failureResponse;
...
class FormBlocSubmissionCancelled<SuccessResponse, FailureResponse> extends FormBlocState<SuccessResponse, FailureResponse> {
  FormBlocSubmissionCancelled({
    Map<int, bool> isValidByStep = const {},
    bool isEditing = false,
    Map<int, Map<String, FieldBloc>> fieldBlocs = const {},
...
/// {@endtemplate}
class FormBlocSubmissionFailed<SuccessResponse, FailureResponse> extends FormBlocState<SuccessResponse, FailureResponse> {
  FormBlocSubmissionFailed({
    Map<int, bool> isValidByStep = const {},
    bool isEditing = false,
    Map<int, Map<String, FieldBloc>> fieldBlocs = const {},
...
/// {@endtemplate}
class FormBlocDeleting<SuccessResponse, FailureResponse> extends FormBlocState<SuccessResponse, FailureResponse> {
  final double progress;
...
/// {@macro form_bloc.form_state.notUseThisClassInsteadUseToMethod}
/// [FormBlocState.toFailure].
class FormBlocDeleteFailed<SuccessResponse, FailureResponse> extends FormBlocState<SuccessResponse, FailureResponse> with EquatableMixin {
  final FailureResponse? failureResponse;
...
/// {@macro form_bloc.form_state.notUseThisClassInsteadUseToMethod}
/// [FormBlocState.toSuccess].
class FormBlocDeleteSuccessful<SuccessResponse, FailureResponse> extends FormBlocState<SuccessResponse, FailureResponse> with EquatableMixin {
  final SuccessResponse? successResponse;
...
class FormBlocUpdatingFields<SuccessResponse, FailureResponse> extends FormBlocState<SuccessResponse, FailureResponse> with EquatableMixin {
  final double progress;
