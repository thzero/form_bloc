...
void main() {
  BlocOverrides.runZoned(
    () => group('FormBloc', () {
      ...
      group('submit', () {
        test('when autoValidate is true and step is invalid, call validate for each field bloc.', () async {
          final formBloc = _FormBlocImpl();
        ...
        test('when autoValidate is true and step is valid, not call validate for each field bloc.', () async {
          final formBloc = _FormBlocImpl();
        ...
        test('onSubmitting can add to state stream all states generated by to methods of state.', () async {
          final formBloc = _FormBlocImpl();
        ...
        test('when autoValidate is false, and submit, call validators and asyncValidators of each fieldBloc that is not validated or have errors.', () async {
